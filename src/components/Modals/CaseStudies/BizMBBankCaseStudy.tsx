    ...
    <div className="flex-1 flex flex-col min-h-0 overflow-hidden bg-[#FFF8E7] select-text">
      ...
      >
        ...
        <section id="sec-04" className="space-y-7 scroll-mt-20">
          ...
          <div className="p-5 sm:p-7 rounded-[12px] bg-[#FFFDF6] border border-[#DFC9A2] shadow-[0_3px_0_#D4C39B] space-y-4">
            <div className="flex items-center justify-between border-b border-[#EAD9B0] pb-3">
              ...
              <span className="text-xs sm:text-sm font-mono text-[#8C5832]">11 Steps End-to-End</span>
            </div>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-3 text-xs sm:text-sm">
              {[
                ...
                <div key={idx} className="p-3.5 rounded-[8px] bg-[#FFF8E7] border border-[#DFC9A2] space-y-1">
                  <div className="flex items-center justify-between">
                    <span className="text-xs font-mono font-bold text-[#B86428]">BƯỚC {item.step}</span>
                    <span className="w-2 h-2 rounded-full bg-[#DFC9A2]" />
                  </div>
                  <div className="font-bold text-[#2D1B12] text-sm sm:text-base">{item.title}</div>
                  <div className="text-xs sm:text-sm text-[#6B513C]">{item.desc}</div>
                </div>
              ))}
            </div>
          </div>
        ...
        <section id="sec-10" className="space-y-7 scroll-mt-20">
          ...
          <div className="p-5 sm:p-7 rounded-[12px] bg-[#FFFDF6] border border-[#DFC9A2] shadow-[0_3px_0_#D4C39B] space-y-3.5">
            <div className="text-xs sm:text-sm font-bold text-[#7A3F1F] uppercase tracking-wider flex items-center gap-2">
              <Lightbulb className="w-4 h-4 text-[#B86428]" />
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-xs sm:text-sm">
              <div className="p-4 rounded bg-[#FFF8E7] border border-[#DFC9A2] space-y-1.5">
                <div className="font-bold text-[#2D1B12] text-sm sm:text-base">01. B2B là trải nghiệm đa vai trò</div>
              ...
              <div className="p-4 rounded bg-[#FFF8E7] border border-[#DFC9A2] space-y-1.5">
                <div className="font-bold text-[#2D1B12] text-sm sm:text-base">02. Một luồng dài không nhất thiết phải làm ngắn lại</div>
                <p className="text-[#5A4030] leading-relaxed">
              ...
              <div className="p-4 rounded bg-[#FFF8E7] border border-[#DFC9A2] space-y-1.5">
                <div className="font-bold text-[#2D1B12] text-sm sm:text-base">03. Handoff là một phần không thể tách rời của UX</div>
                <p className="text-[#5A4030] leading-relaxed">
              ...
              <div className="p-4 rounded bg-[#FFF8E7] border border-[#DFC9A2] space-y-1.5">
                <div className="font-bold text-[#2D1B12] text-sm sm:text-base">04. Design không bao giờ kết thúc ở Prototype</div>
                <p className="text-[#5A4030] leading-relaxed">
          ...
          <div className="p-5 sm:p-7 rounded-[12px] bg-[#FFFDF6] border-2 border-[#DFC9A2] shadow-[0_3px_0_#D4C39B] space-y-4">
            <div className="flex items-center justify-between border-b border-[#EAD9B0] pb-3">
              ...
              <span className="text-xs sm:text-sm font-mono text-[#B86428] font-bold">Continuous Loop</span>
            </div>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-7 gap-2.5 text-center text-xs">
              {[
                ...
                <div key={idx} className="p-3 rounded-[8px] bg-[#FFF8E7] border border-[#DFC9A2] space-y-1">
                  ...
                  <div className="font-bold text-[#2D1B12] leading-tight text-xs sm:text-sm">{item.title}</div>
                  <div className="text-xs text-[#7A3F1F] font-medium">{item.sub}</div>
                </div>
              ))}
            </div>
          </div>
          ...
          <div className="p-6 sm:p-9 rounded-[14px] bg-gradient-to-br from-[#FFF4D6] via-[#FFFDF6] to-[#FFECC2] border-2 border-[#B86428] shadow-md space-y-4 text-center max-w-4xl mx-auto">
            <Sparkles className="w-7 h-7 text-[#B86428] mx-auto" />
            <blockquote className="text-lg sm:text-2xl font-bold text-[#2D1B12] leading-relaxed italic">
            ...
            <p className="text-sm sm:text-base text-[#4A2414] font-medium max-w-2xl mx-auto leading-relaxed">
          ...
          <div className="p-4 sm:p-5 rounded-[10px] bg-[#FFF8E7] border border-[#DFC9A2] text-xs sm:text-sm text-[#5A4030] space-y-2">
            <div className="font-bold text-[#7A3F1F] uppercase tracking-wider flex items-center gap-2">
              <Shield className="w-4 h-4 text-[#B86428]" />
          ...
          <div className="pt-4 flex justify-center">
            <button
              onClick={onBack}
              className="inline-flex items-center gap-2.5 px-8 py-3 rounded-[6px] bg-[#F4C542] hover:bg-[#FFD55C] text-[#2D1B12] font-sans text-sm sm:text-base font-bold border-2 border-[#4A2414] shadow-[0_3px_0_#4A2414] active:translate-y-0.5 transition-all cursor-pointer"
            >
              <ArrowLeft className="w-4 h-4" />
